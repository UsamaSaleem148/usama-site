...
export default function Hero() {
  return (
    <section id='home' className='relative min-h-screen flex flex-col items-center justify-center py-32 bg-background overflow-hidden'>
      {/* Grid background */}
      ...
      <div className='mx-auto max-w-5xl text-center px-6 relative z-10'>
        ...
        >
          Full-stack engineer specializing in scalable web apps, AI integrations, and cloud infrastructure — trusted by
          startups and healthcare platforms worldwide.
        </motion.p>
        ...
        >
          ...
          <div className='flex flex-wrap justify-center items-center gap-x-10 gap-y-3'>
            {['Novus Health', 'Booltec', 'DaoSeeder', 'Heerekar', 'Martian Marketing', 'ClickThrive'].map((name) => (
              <span key={name} className='text-sm font-semibold text-muted-foreground/70 hover:text-foreground transition-colors duration-200'>
                {name}
              </span>
            ))}
          </div>
