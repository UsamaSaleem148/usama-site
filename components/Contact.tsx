      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Tell me about your project, business goals, and requirements.
          ...
          >
            ...
            <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-bold text-foreground">Prefer to talk?</h3>
              </div>
            ...
            {/* Social links */}
            <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
              <h3 className="font-bold text-foreground mb-4">Find Me Online</h3>
            ...
            <div className="flex items-start gap-2 px-4 py-3 rounded-xl bg-green-500/8 border border-green-500/20">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                for new projects — freelance &amp; contract work worldwide.
              </p>
            </div>
          </motion.div>
        </div>
