  ...
  return (
    <section id='testimonials' className='py-24 bg-background'>
      <div className='max-w-7xl mx-auto px-6'>
        ...
        >
          <p className='text-sm uppercase tracking-widest text-primary font-semibold mb-3'>Testimonials</p>
          <h2 className='text-4xl sm:text-5xl font-bold text-foreground'>What My Clients Say</h2>
        </motion.div>
                ...
                >
                  <div className='h-full relative rounded-2xl border border-border bg-card shadow-md hover:shadow-xl transition-all duration-300 p-6 overflow-hidden group'>
                    ...
                    <div className='relative z-10 flex flex-col h-full'>
                      <Stars />
                      <svg className='w-7 h-7 text-primary/40 mb-3' fill='currentColor' viewBox='0 0 24 24'>
        ...
        >
          <p className='text-muted-foreground mb-4'>
            Join <span className='font-semibold text-foreground'>30+ happy clients</span> who&apos;ve shipped with me
          </p>
          <a
            href='#contact'
