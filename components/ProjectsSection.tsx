...
const featuredProjects: Project[] = [
  {
    title: "Novus Health",
    description:
      "Comprehensive healthcare SaaS platform for online doctor appointments, EMR management, and medical consultations — deployed across multiple countries.",
  ...
  },
  {
    title: "DaoSeeder",
    description:
      "Decentralized crowdfunding platform with DAO governance, IPFS storage, and smart contract-based fundraising rounds.",
  ...
  },
  {
    title: "CinemaGlimpse",
    description:
      "Movie discovery and entertainment platform with advanced search, personalised recommendations, and real-time ratings.",
  ...
  },
  {
    title: "LeadsBounty",
    description:
      "Lead generation and CRM platform helping businesses capture, qualify, and nurture prospects at scale.",
  ...
  },
  {
    title: "SNA Platform",
    description:
      "Decentralized social media application on blockchain — secure, private social networking with IPFS-based content storage.",
...
const businessProjects: Project[] = [
  {
    title: "ClickThrive",
    description:
      "Digital marketing agency website with lead generation funnels, service showcase, and conversion-optimised landing pages.",
  ...
  },
  {
    title: "Booltec",
    description:
      "Technology solutions company website showcasing services, case studies, and a polished corporate identity.",
  ...
  },
  {
    title: "Heerekar",
    description:
      "Professional services marketplace connecting clients with skilled local professionals — design-first approach.",
    // result: "Delivered in 3 weeks, on budget",
  ...
  },
  {
    title: "Khareedo",
    description:
      "E-commerce store with WooCommerce, custom theme design, and a mobile-first shopping experience.",
    // result: "Delivered in 4 weeks, on budget",
  ...
  },
  {
    ...
    description:
      "Full digital marketing agency platform with comprehensive service pages, blog, and analytics integration.",
    // result: "Delivered in 3 weeks, on budget",
    techStack: "WordPress",
  ...
  },
  {
    ...
    description:
      "Complete restaurant website with menu management, online ordering, and staff booking system.",
    // result: "Delivered in 2 weeks, on budget",
    techStack: "WordPress",
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              A selection of web applications, SaaS platforms, and custom
              software built for businesses and startups.
            </p>
          </motion.div>
          ...
          {/* Business Websites & E-Commerce subsection */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <h3 className="text-lg font-semibold text-muted-foreground whitespace-nowrap">
